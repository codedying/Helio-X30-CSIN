...
echo 50 > /proc/cpufreq/cpufreq_up_threshold_b
echo 50 > /proc/cpufreq/cpufreq_up_threshold_l
echo 50 > /proc/cpufreq/cpufreq_up_threshold_ll
...
echo "4-6" > /dev/cpuset/foreground/effective_cpus
